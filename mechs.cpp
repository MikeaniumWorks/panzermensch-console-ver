...
public:
    ...
    void emperor_ability() {
        std::cout << "ALL SHALL FACE THE WRATH OF HUMANITY!" << std::endl;
    }
...
public:
    ...
    void panzer_ability() {
        std::cout << "BULWARK STANDS!" << std::endl;
    }
};
...
public:
    ...
    void artemis_ability() {
        std::cout << "Artemis Lance Active!" << std::endl;
    }
...
public:
    ...
    void aegis_ability() {
        std::cout << "Aegis's Ability Is Accessed!" << std::endl;
    }
...
public:
    ...
    void admin_ability() {
        std::cout << "BANHAMMER ACTIVE!" << std::endl;
    }
...
public:
    ...
    void krieg_ability() {
        std::cout << "Krieg's Ability Is Accessed!" << std::endl;
    }
...
public:
    ...
    void orion_ability() {
        std::cout << "Orion's Ability Is Accessed!" << std::endl;
    }
